...
export const peopleApi = {
  ...
  // Parents
  registerParent: (data: any) => api.post('/parents/register', data),
  getParentRequests: () => api.get('/parents/requests'),
  approveParent: (id: number) => api.patch(`/parents/${id}/approve`),
  rejectParent: (id: number) => api.patch(`/parents/${id}/reject`),
  getParentNotifications: () => api.get('/parents/notifications'),
  markParentNotificationRead: (id: number) => api.patch(`/parents/notifications/${id}/read`),
};
