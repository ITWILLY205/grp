  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-24">
      ...
      <div className="relative mx-auto max-w-5xl text-center">
        ...
        >
          From attendance to live classes, grades to analytics — Esms unifies
        ...
        >
          <button className="group flex items-center gap-2 rounded-xl bg-hero-gradient px-8 py-3.5 text-sm font-semibold text-primary-foreground transition-all hover:glow-primary">
            Start Free Trial
            <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
          </button>
          <button className="flex items-center gap-2 rounded-xl border border-border bg-surface px-8 py-3.5 text-sm font-semibold text-foreground transition-colors hover:bg-secondary">
