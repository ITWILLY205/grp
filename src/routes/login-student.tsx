...
import { GraduationCap, ArrowRight, Users, Lock, User } from "lucide-react";
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.success && response.data.user.role === 'STUDENT') {
        ...
        logLogin(user.full_name, username, "student", { loginMethod: "username_password" });
        navigate({ to: "/student" });
      ...
      logFailedLogin(username || "unknown", "Invalid student credentials");
    }
  };
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-xl border border-input bg-card pl-10 pr-4 py-2.5 text-sm text-foreground placeholder-muted-foreground outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary"
                  />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-xl border border-input bg-card pl-10 pr-10 py-2.5 text-sm text-foreground placeholder-muted-foreground outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary"
                  />
                  <button
                    type="button"
