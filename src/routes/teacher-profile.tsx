...
import { Mail, Phone, Calendar, BookOpen, User, DollarSign, MapPin, AlertCircle, Loader2 } from "lucide-react";
...
function TeacherProfilePage() {
  ...
  const fetchProfile = async () => {
    try {
      const res = await peopleApi.getTeacherMe();
      setTeacher(res.data);
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="w-full max-w-7xl mx-auto px-6 pt-8 pb-12">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">Your personal and professional information</p>
        </div>
